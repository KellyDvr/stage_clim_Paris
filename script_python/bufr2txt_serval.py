...
datebegin = datetime.datetime.strptime("201908010000", '%Y%m%d%H%M')
dateend = datetime.datetime.strptime("201909010000", '%Y%m%d%H%M')
...
while date <= dateend :
    ...
    os.system('scp doeuvrek@sotrtm33-sidev:/home/mrmu/doeuvrek/lunairs/RESULT/RADAR/COMPOSIT_ELLIPSO/REFLECTIVITE/*.text /cnrm/ville/USERS/doeuvrek/donnees' )
